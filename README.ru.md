...
Запустите `wow-ping.exe` с опцией `-servers`, чтобы выбрать конфиг серверов. Например, `wow-ping.exe -servers x1` загрузит конфиг серверов из файла `servers/x1.json`.
